...
//         return WebResourceFactory.newResource(QueryResourceClient.class, target);            
//         // try {
//         //     WebTarget webTarget = ClientBuilder.newClient().target(UriBuilder.fromPath(urlPath));
//         //     return WebResourceFactory.newResource(QueryResourceClient.class, webTarget);
//         // }
//         // catch(Exception e){
//         //     e.printStackTrace();
//         //     throw e;
...
//         System.out.println(" MockServerContainer.PORT: "+ MockServerContainer.PORT); //1080
//         queryContainer.start();
...
//         System.out.println("uri for rest client is: "+uri);

//         client = createRestClient(uri);
//     }
//     @BeforeEach
//     public void setup() throws InterruptedException {
//         System.out.println("printing mockserver port");
