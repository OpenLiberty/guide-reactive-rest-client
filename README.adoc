...
[source, java, linenums, role='code_column hide_tags=copyright,importobservable,secondgetSystem']
----
...
InventoryClient.java
[source, java, linenums, role='code_column hide_tags=copyright,importjava,importjavax,firstgetSystem']
----
