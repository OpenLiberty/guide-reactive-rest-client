...
:page-seo-title: Consuming RESTful Java microservices using reactive JAX-RS client
:page-seo-description: A getting started tutorial and an example on how to consume RESTful Java microservices asynchronously using reactive Java API for RESTful Web Services (JAX-RS) client.
