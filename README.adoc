...
The ReactiveX API and the required Jersey libraries are included as dependencies to your [hotspot file=0]`pom.xml` file. Look for the dependencies with [hotspot=111 file=0]`rxjava`, [hotspot=116 file=0]`jersey-client`, [hotspot=121 file=0]`jersey-rx-client-rxjava` and [hotspot=126 file=0]`jersey-rx-client-rxjava2`.
