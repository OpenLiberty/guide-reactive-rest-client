...
The `RxFlowableInvoker` and `RxFlowableInvokerProvider` classes are provided by the [hotspot=jerseyRxjava2 file=0]`jersey-rx-client-rxjava2` dependency, which is included to try as an optional exercise. 
