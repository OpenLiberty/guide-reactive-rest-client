...
The ReactiveX API and the required Jersey libraries are included as dependencies to your [hotspot file=0]`gateway/pom.xml` file. Look for the dependencies with [hotspot=83-87 file=0]`rxjava`, [hotspot=88-92 file=0]`jersey-client`, [hotspot=93-97 file=0]`jersey-rx-client-rxjava` and [hotspot=98-102 file=0]`jersey-rx-client-rxjava2`.
