...
You'll learn how to create a reactive JAX-RS client application using the default JAX-RS reactive provider and a pluggable reactive provider for RxJava published by https://eclipse-ee4j.github.io/jersey[Eclipse Jersey^]. 
...
Although JAX-RS provides the default reactive provider which returns `CompletionStage` types, you can alternatively use another provider that supports the use of other reactive frameworks like https://github.com/ReactiveX/RxJava[RxJava^]. 
